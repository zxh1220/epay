...
<body>
    ...
    <div class="row row-grid align-items-center">
                ...
                <div class="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                    ...
                    <p class="lead text-center text-md-left text-muted">
                       彩虹易支付为每一个需要支付服务的企业提供服务和技术支持，帮助企业快速的搭建自己的支付系统。现在如今，支付是商业变现必不可少的环节。我们聚合所有主流支付渠道，给你更简单、快捷的接入体验，同时提供简单易用的管理平台，让你可以集中进行跨渠道的交易管理和财务管理。我们致力于帮助企业快速和高质量地建立支付模块，满足企业任何支付场景的需求！
                    </p>
                    <!-- Buttons -->
    ...
    <section class="slice slice-lg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <span class="badge badge-primary badge-pill">彩虹易支付</span>
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8">
                    ...
                    <p class="lead text-muted">
                         彩虹易支付是国内领先的支付技术解决方案服务商，致力于帮助企业最低成本接入一套优雅、可靠的支付系统，并以可视化的数据辅助其完成商业决策。
                    </p>
                    <!-- Buttons -->
                    <div class="mt-5">
