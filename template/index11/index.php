...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/template/index11/new/assets/newindex/bootstrap.min.css">
    <link rel="stylesheet" href="/template/index11/new/assets/newindex/all.min.css">
    <link rel="stylesheet" href="/template/index11/new/assets/newindex/swiper.min.css">

    <script src="/template/index11/new/assets/newindex/jquery.slim.min.js"></script>
    <script src="/template/index11/new/assets/newindex/popper.min.js"></script>
    <script src="/template/index11/new/assets/newindex/bootstrap.min.js"></script>

    <link rel="stylesheet" href="/template/index11/new/assets/newindex/style.css">
    <link rel="stylesheet" href="/template/index11/new/assets/newindex/bootstrap.min(1).css">
    <link rel="stylesheet" href="/template/index11/new/assets/newindex/materialdesignicons.min.css">
...
<body>
            ...
            <div class="navbar-collapse collapse" id="navbarCollapse" style="">
                <ul class="navbar-nav ms-auto navbar-center" id="navbar-navlist">
                    ...
                    <li class="nav-item"><a href="/user/test.php" class="nav-link">测试</a></li>
                                ...
                                <a href="/user/login.php" class="btn btn-sm rounded-pill nav-btn ms-lg-3"><i class="fas fa-sign-in-alt"></i> 登录</a>
                            </div>
        </div>
        <!-- end container -->
    </nav>
    ...
    <!-- Hero Start -->
    <section class="hero-1 bg-center bg-primary position-relative" style="background-image: url(/template/index11/new/assets//newindex/hero-g-bg.png);" id="home">
        <div class="container">
            <div class="row align-items-center hero-content">
                <div class="col-lg-5">
                    <h1 class="text-white display-4 font-weight-bold mb-4 hero-1-title"><?=$conf['sitename']?></h1>
                    <p class="text-white-70 mb-4"> <?=$conf['sitename']?>,以信誉求市场,以稳定求发展，行业内最安全，简单易用，专业的技术团队，最放心的支付平台。费率低至0.5％、会员费率更低！！；</p>
                    <a class="btn btn-lg btn-light rounded-pill mb-2" href="/user/login.php"><strong>开始使用</strong> <i class="fa fa-plane" aria-hidden="true"></i></a>
                </div>
                ...
                <div id="carouselExampleIndicators" class="col-lg-6 col-sm-12 mx-auto ms-lg-auto me-lg-0 carousel slide pointer-event" data-ride="carousel">
                    <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-ios">
                        <!--<div class="swiper-wrapper" style="transform: translate3d(-2544px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="2" style="width: 636px;"><img src="/template/new/assets/newindex/banner-hulu-333.png" class="d-block w-100"></div>-->
                            ...
                            <div class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 636px;"><img src="/template/index11/new/assets/newindex/banner-hbo-1111.png" class="d-block w-100">
                                <p></p>
                            </div>
        ...
        <div class="hero-bottom-shape">
            <img src="/template/index11/new/assets/newindex/hero-1-bottom-shape.png" alt="" class="img-fluid d-block mx-auto">
        </div>
        <!-- end hero shape -->
    </section>
    <!-- Hero End -->
                ...
                <div class="col-lg-4">
                    <div class="service-box text-center px-4 py-5 position-relative mb-4">
                        <div class="service-box-content p-4">
                            ...
                            <h4 class="mb-3 font-size-22">支付宝</h4>
                    ...
                    <div class="service-box text-center px-4 py-5 position-relative mb-4 active">
                        <div class="service-box-content p-4">
                            <div class="icon-mono service-icon avatar-md mx-auto mb-4">
                                ...
                                <!--</svg>-->
                                <img src="/template/index11/assets/template/includes/img_16.png" alt="" class="img-fluid d-block mx-auto">
                            </div>
                            <h4 class="mb-3 font-size-22 text-white-90">微信</h4>
                    ...
                    <div class="service-box text-center px-4 py-5 position-relative mb-4">
                        <div class="service-box-content p-4">
                            <div class="icon-mono service-icon avatar-md mx-auto mb-4">
                                ...
                                <!--</svg>-->
                                <img src="/template/index11/assets/template/includes/img_17.png" alt="" class="img-fluid d-block mx-auto">
                            </div>
                            <h4 class="mb-3 font-size-22">QQ钱包</h4>
    ...
    <section class="section bg-light" id="features" tabindex="-1" style="outline: none;">
        ...
        <div class="row align-items-center mb-5">
                <div class="col-md-5 order-2 order-md-1 mt-md-0 mt-5">
                    ...
                    <p class="text-muted mb-5"><?=$conf['sitename']?>·通过简单的页面配置，可以替代复杂繁琐的人工资金结算业务，提高业务实时性，降低错误。</p>
...
<!--</video>-->
                            <img src="/template/index11/new/assets/newindex/td2.png" alt="" class="img-fluid d-block mx-auto">
                        </div>
                        <img src="/template/index11/new/assets/newindex/dot-img.png" alt="" class="dot-img-left">
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-md-6 ms-md-auto order-1 order-md-2">
                    <div class="position-relative">
                        <div class="ms-5 features-img">
                            <img src="/template/index11/new/assets/newindex/jh.png" alt="" class="img-fluid d-block mx-auto">
                        </div>
                        <img src="/template/index11/new/assets/newindex/dot-img.png" alt="" class="dot-img-left">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="position-relative mb-md-0 mb-5">
                        <div class="me-5 features-img">
                            <img src="/template/index11/new/assets/newindex/zf.png" alt="" class="img-fluid d-block mx-auto rounded shadow">
                        </div>
                        <img src="/template/index11/new/assets/newindex/dot-img.png" alt="" class="dot-img-right">
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center">
                        ...
                        <a href="https://wpa.qq.com/msgrd?v=3&uin=1077629768&site=qq&menu=yes" class="btn btn-lg btn-light fw-bold">联系我们</a>
                    </div>
                </div>
                <!-- end col -->
            </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <ul class="list-unstyled footer-sub-menu">
                                    ...
                                    <li class="text-end">
                                        <a href="doc/index.html" class="footer-link">对接文档</a>
                                    </li>
                                    <li class="text-end">
    ...
    <!-- javascript -->
    <script src="/template/index11/new/assets/newindex/bootstrap.bundle.min.js"></script>
    <script src="/template/index11/new/assets/newindex/smooth-scroll.polyfills.min.js"></script>

    <!-- App Js -->
    <script src="/template/index11/new/assets/newindex/feather-icons"></script>
    <script src="/template/index11/new/assets/newindex/app.js"></script>

    <!--End mc_embed_signup-->
    <script src="/template/index11/new/assets/newindex/swiper.min.js"></script>
    <script>
