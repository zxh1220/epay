...
<head>
    ...
    <link rel="stylesheet" href="template/index14/css/fontawesome-all.min.css">

    <!-- Template CSS Style link -->

    <link rel="stylesheet" href="template/index14/css/style-starter.css">

	<link rel="stylesheet" href="template/index14/css/style.css">

	<link rel="stylesheet" href="template/index14/css/iconfont.css">

	<link rel="stylesheet" href="template/index14/css/animate.min.css">

	<link rel="stylesheet" href="template/index14/css/qietu.css">
            ...
            <nav class="navbar navbar-expand-lg stroke px-0">
                <h1>
                    <a class="navbar-brand" href="index.php">
                        <i class="fab fa-accusoft icon-color mr-1"></i><?php echo $conf['sitename']?></span>
                    </a>
                </h1>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <!--</li>-->
                        <li class="nav-item">
                            <a class="nav-link" href="doc.html" target="_blank">接口文档</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="agreement.html" target="_blank">服务条款</a>
                        </li>
                        ...
                        <!--        <input type="search" placeholder="搜索" name="search" required="required" autofocus class="search-popup">-->
            ...
            <div class="container pt-5 pb-md-4">
                <div class="row align-items-center">
                    <div class="col-md-6 pt-md-0 pt-4">
                        ...
                        <p><?php echo $conf['sitename']?>&nbsp;-&nbsp;个人微信支付宝收款辅助工具，无资金托管避免跑路，收款即时到账，安全可靠，让每一笔收款变得更简单。</p>
                        <div class="mt-md-5 mt-4 mb-lg-0 mb-4">
                            <a class="btn button-style" href="/user/reg.php">立即开户</a>
                        </div>
                    </div>
                    <div class="col-md-6 mt-md-0 mt-4">
                        <img class="img-fluid" src="template/index14/images/bann1.png" alt=" ">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-lg-5 py-4">
            <div class="row align-items-center">
                <div class="col-md-6 content-photo order-md-first order-last">
                    <a href="#image"><img src="template/index14/images/home-ab.png" class="img-fluid" alt="content-photo"></a>
                </div>
                <div class="col-md-6 content-left mb-md-0 mb-5 pl-lg-5 order-md-last order-first">
                    <h3 class="mb-3">Welcome To <?php echo $conf['sitename']?></h3>
                    <p>支持不同业务场景的交易方式。
					</p>
                    <p class="mt-3">独家首创支持多微信、多支付宝、多QQ同时收款，多号轮询，轻松应付产品高并发烦恼。</p>
                    <a class="btn button-style mt-lg-5 mt-4" href="/user/reg.php">立即开户</a>
                </div>
			</div>
            </div>
        </div>
...
<!-- features section -->
            <div class="hhelp-hd g-hd" id="shoukuan">
				...
				<p class="wow fadeInUp animated" data-wow-delay=".5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">-Pay-</p>
			</div>
                    ...
                    <div class="col-lg-4 col-md-6 column column-img" id="zoomIn">
                        <div class="services-gd">
                            <div class="serve-info">
                                <a href="#blog">
                                    <figure>
                                        <img class="img-responsive" src="template/index14/images/blog1.jpeg" alt="blog-image">
                                    </figure>
                                </a>
                                <center><h3> <a href="#blog" class="vv-link"><?php echo $conf['sitename']?></a>
                                </h3></center><br>
                    ...
                    <div class="col-lg-4 col-md-6 column column-img mt-md-0 mt-5" id="zoomIn">
                        <div class="services-gd">
                            <div class="serve-info">
                                <a href="#blog">
                                    <figure>
                                        <img class="img-responsive" src="template/index14/images/blog2.jpeg" alt="blog-image">
                                    </figure>
                                </a>
                                <center><h3> <a href="#blog" class="vv-link"><?php echo $conf['sitename']?></a>
                                </h3></center><br>
                    ...
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-md-5 mt-5 column column-img" id="zoomIn">
                        <div class="services-gd">
                            <div class="serve-info">
                                <a href="#blog">
                                    <figure>
                                        <img class="img-responsive" src="template/index14/images/blog3.jpeg" alt="blog-image">
                                    </figure>
                                </a>
                                <center><h3> <a href="#blog" class="vv-link"><?php echo $conf['sitename']?></a>
                                </h3></center><br>
            ...
            <div class="container py-md-5 py-4">
                <div class="row aap-4-section">
                    <div class="col-lg-6 app4-right-image">
                        <img src="template/index14/images/mobile.png" class="img-fluid" alt="App Device">
                    </div>
                    <div class="col-lg-6 app4-left-text pl-lg-0 mb-lg-0 mb-5">

                        <h4>因为专业，值得信赖</h4><br>
                        <p class="mb-4"> 即时到账、安全可靠、方便快捷是我们最大的特点，轻松实现手机付款、在线收款。<?php echo $conf['sitename']?>是您的不二之选，欢迎咨询<?php echo $conf['sitename']?>。</p>
                ...
                <div class="row footer-p">
                    <div class="col-lg-8 mt-lg-0 mt-4 pr-lg-5">
                        <div class="d-sm-flex align-items-center top-footer-content mb-5">
                            <a class="logo d-flex align-items-center" href="./"><i class="fab fa-accusoft icon-color mr-1"></i><?php echo $conf['sitename']?></span></a>
                            <p class="top-p ml-sm-4 pl-sm-4 mt-sm-0 mt-2">您永远不会想象那么强大的业务可以轻松实现<br>为您提供多种解决方案。</p>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-7 column mt-lg-0 mt-4">
                        <h3>极速稳定 - <?php echo $conf['sitename']?></h3>
    ...
    <script src="template/index14/js/jquery-3.3.1.min.js"></script>
    <!-- //common jquery plugin -->
    ...
    <script>
        ...
        const textArray = ["Welcome To Pay"];
    ...
    <!-- owl carousel -->
    <script src="template/index14/js/owl.carousel.js"></script>
    ...
    <script src="template/index14/js/theme-change.js"></script>
    <script>
    ...
    <!-- magnific popup -->
    <script src="template/index14/js/jquery.magnific-popup.js"></script>
    <script>
        $(document).ready(function () {
    ...
    <script src="template/index14/js/jquery.magnific-popup.js"></script>
    <!-- //bootstrap-->
	<script type="text/javascript" src="template/index14/js/jquery.js"></script>
    <script type="text/javascript" src="template/index14/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="template/index14/js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="template/index14/js/jquery.glide.js"></script>
	<script type="text/javascript" src="template/index14/js/wow.min.js"></script>
	<script type="text/javascript" src="template/index14/js/script.js"></script>
    <!-- //Js scripts -->
</body>
